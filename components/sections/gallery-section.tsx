...
export function GallerySection() {
  ...
  const images = [
    { src: "/atelier-commerce/images/mono-1.png", alt: "Modern architecture at sunrise" },
    { src: "/atelier-commerce/images/mono-2.png", alt: "Modern architecture in daylight" },
    { src: "/atelier-commerce/images/mono-3.png", alt: "Modern architecture at dusk" },
    { src: "/atelier-commerce/images/mono-4.png", alt: "Modern architecture at night" },
  ];
          ...
          {images.map((image, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Image
                    src={image.src || "/atelier-commerce/placeholder.svg"}
                    alt={image.alt}
                    fill

...
const accessories = [
  {
    ...
    price: "$285,000",
    image: "/atelier-commerce/images/hero-side-1.png",
  },
  {
    id: 2,
    name: "Standard Model",
    ...
    price: "$395,000",
    image: "/atelier-commerce/images/hero-side-2.png",
  },
  {
    id: 3,
    name: "Premium Model",
    ...
    price: "$525,000",
    image: "/atelier-commerce/images/hero-side-4.png",
  },
];
          ...
          {accessories.map((accessory) => (
            <div key={accessory.id} className="group flex-shrink-0 w-[75vw] snap-center">
              ...
              <div className="relative aspect-[2/3] overflow-hidden rounded-2xl bg-secondary">
                <FadeImage
                  src={accessory.image || "/atelier-commerce/placeholder.svg"}
                  alt={accessory.name}
                  fill
